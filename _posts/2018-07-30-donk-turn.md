...
---
>Theorie :
>Quand on check / call, on check tout le temps la turn car notre range est plus faible car on n'a pas check / raise, néanmoins sur certaines cartes ça peut faire sens d'avoir une range de donk bet petit, sur des cartes qui changent l'équité des range fortement, sur une brique les équités restent similaires au flop mais sur une doublette ou une carte faisant rentrer une flush ou une quinte
...
**BTN passe**
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5Njk1ODE1Myw3MDAwNDIyNDEsLTE2OD
